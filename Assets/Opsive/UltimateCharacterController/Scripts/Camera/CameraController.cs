...
namespace Opsive.UltimateCharacterController.Camera
{
    ...
    public class CameraController : StateBehavior, ILookSource, Shared.Camera.ICamera
    {
        ...
        {
            get { return m_FirstPersonViewTypeFullName; }
            set
            {
        ...
        {
            get { return m_ThirdPersonViewTypeFullName; }
            set
            {
        ...
        public void Move(float horizontalMovement, float verticalMovement)
        {
            ...
            if (m_ViewType.RotatePriority)
            {
                m_Transform.position = m_ViewType.Move(true); 
                m_Transform.position = Vector3.MoveTowards(m_Transform.position, m_ViewType.Move(true), Time.deltaTime * smoothValue);
            }
            else
            {
            ...
            //{
            //    m_Transform.Translate(transform.forward * Time.deltaTime * 10);
            //}
        }
